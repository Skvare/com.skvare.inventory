...
DROP TABLE IF EXISTS `civicrm_inventory_warehouse_transactions`;
DROP TABLE IF EXISTS `civicrm_inventory_warehouse`;
DROP TABLE IF EXISTS `civicrm_inventory_sales`;
DROP TABLE IF EXISTS `civicrm_inventory_provider`;
...
-- /*******************************************************
-- *
-- * civicrm_inventory_provider
-- *
-- * FIXME
-- *
-- *******************************************************/
CREATE TABLE `civicrm_inventory_provider` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Inventory Provider ID',
  `provider_name` varchar(100) NOT NULL,
  `address_id` int unsigned COMMENT 'Provider Location',
  `contact_id` int unsigned COMMENT 'FK to Contact',
  PRIMARY KEY (`id`),
  CONSTRAINT FK_civicrm_inventory_provider_address_id FOREIGN KEY (`address_id`) REFERENCES `civicrm_address`(`id`) ON DELETE SET NULL,
  CONSTRAINT FK_civicrm_inventory_provider_contact_id FOREIGN KEY (`contact_id`) REFERENCES `civicrm_contact`(`id`) ON DELETE CASCADE
)
ENGINE=InnoDB;
...
-- /*******************************************************
-- *
-- * civicrm_inventory_warehouse_transactions
-- *
-- * Warehouse Transaction
-- *
-- *******************************************************/
CREATE TABLE `civicrm_inventory_warehouse_transactions` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'Unique Inventory Warehouse Stock Transactions ID',
  ...
  `type` varchar(100) NOT NULL COMMENT 'IN = into location, OUT = OUT of location',
  `contact_id` int unsigned COMMENT 'FK to Contact',
  `action_date` datetime,
  PRIMARY KEY (`id`),
  CONSTRAINT FK_civicrm_inventory_warehouse_transactions_product_variant_id FOREIGN KEY (`product_variant_id`) REFERENCES `civicrm_inventory_product_variant`(`id`) ON DELETE SET NULL,
  CONSTRAINT FK_civicrm_inventory_warehouse_transactions_warehouse_id FOREIGN KEY (`warehouse_id`) REFERENCES `civicrm_inventory_warehouse`(`id`) ON DELETE SET NULL,
  CONSTRAINT FK_civicrm_inventory_warehouse_transactions_contact_id FOREIGN KEY (`contact_id`) REFERENCES `civicrm_contact`(`id`) ON DELETE SET NULL
)
ENGINE=InnoDB;
...
CREATE TABLE `civicrm_inventory_order_detail` (
  ...
  `product_variant_id` int unsigned COMMENT 'FK to Product Variant',
  `provider_id` int unsigned COMMENT 'FK to Provider',
  `warehouse_id` int unsigned COMMENT 'FK to Warehouse',
  `order_quantity` int unsigned COMMENT 'Order quantiy to provider',
  ...
  CONSTRAINT FK_civicrm_inventory_order_detail_provider_id FOREIGN KEY (`provider_id`) REFERENCES `civicrm_inventory_provider`(`id`) ON DELETE SET NULL,
  CONSTRAINT FK_civicrm_inventory_order_detail_warehouse_id FOREIGN KEY (`warehouse_id`) REFERENCES `civicrm_inventory_warehouse`(`id`) ON DELETE SET NULL
)
ENGINE=InnoDB;
