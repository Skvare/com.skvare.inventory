 ...
 * (GenCodeChecksum:51ebd3a8a7431aaaf21479507b9f3c97)
 */
...
class CRM_Inventory_DAO_InventoryWarehouseTransfer extends CRM_Core_DAO {
  ...
  public static function getReferenceColumns() {
    if (!isset(Civi::$statics[__CLASS__]['links'])) {
      ...
      Civi::$statics[__CLASS__]['links'][] = new CRM_Core_Reference_Basic(self::getTableName(), 'from_warehouse_id', 'civicrm_inventory_warehouse', 'id');
      Civi::$statics[__CLASS__]['links'][] = new CRM_Core_Reference_Basic(self::getTableName(), 'to_warehouse_id', 'civicrm_inventory_warehouse', 'id');
      Civi::$statics[__CLASS__]['links'][] = new CRM_Core_Reference_Basic(self::getTableName(), 'from_contact_id', 'civicrm_contact', 'id');
      Civi::$statics[__CLASS__]['links'][] = new CRM_Core_Reference_Basic(self::getTableName(), 'to_contact_id', 'civicrm_contact', 'id');
  ...
  public static function &fields() {
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        ...
        'inventory_warehouse_tranfer_product_variant_id' => [
        ...
        'inventory_warehouse_tranfer_from_warehouse_id' => [
        ...
        'inventory_warehouse_tranfer_to_warehouse_id' => [
        ...
        'inventory_warehouse_tranfer_from_contact_id' => [
        ...
        'inventory_warehouse_tranfer_to_contact_id' => [
          'name' => 'to_contact_id',
          'type' => CRM_Utils_Type::T_INT,
          'title' => E::ts('Recivied By'),
          'description' => E::ts('FK to Contact'),
          'usage' => [
            'import' => FALSE,
            'export' => FALSE,
        ...
        'inventory_warehouse_tranfer_created_date' => [
          'name' => 'created_date',
        ...
        'inventory_warehouse_tranfer_status_id' => [
          'name' => 'status_id',
          'type' => CRM_Utils_Type::T_STRING,
        ...
        'inventory_warehouse_tranfer_status_date' => [
          'name' => 'status_date',
          'type' => CRM_Utils_Type::T_DATE + CRM_Utils_Type::T_TIME,
