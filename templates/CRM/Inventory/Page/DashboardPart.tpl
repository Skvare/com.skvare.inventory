{if $part eq 'device'}
  <div style="padding-bottom: 10px;padding-top: 10px;">
    ...
    <a target="_blank" class="action-item crm-hover-button" href='{crmURL p="civicrm/inventory/product" q="reset=1"}'><i class="crm-i fa-plus" aria-hidden="true"></i> {ts}Device Listing (tabs) (WIP){/ts}</a>
    <br/>
...
{elseif $part eq 'order'}
  <div style="padding-bottom: 10px;padding-top: 10px;">
    <a target="_blank" class="action-item crm-hover-button" href='{crmURL p="civicrm/inventory/order-details?reset=1" q="reset=1"}'><i class="crm-i fa-plus" aria-hidden="true"></i> {ts}Order Details (WIP){/ts}</a>
  </div>
